(function (global, factory) {
  ...
  var DOMCollection = createCommonjsModule(function (module, exports) {
    ...
    var serialize = function (collection, config, indentation, depth, refs, printer) {
      ...
      return (config.min ? '' : name + ' ') + (OBJECT_NAMES.indexOf(name) !== -1 ? '{' + (0, collections.printObjectProperties)(isNamedNodeMap(collection) ? Array.from(collection).reduce(function (props, attribute) {
        ...
        return props;
      }, {}) : _extends$1({}, collection), config, indentation, depth, refs, printer) + '}' : '[' + (0, collections.printListItems)(Array.from(collection), config, indentation, depth, refs, printer) + ']');
    };
  ...
  */
  ...
  function prettyDOM(dom, maxLength, options) {
    ...
    var debugContent = prettyFormat(dom, _extends$1({
  ...
  function configure(newConfig) {
    ...
    config = _extends$1({}, config, newConfig);
  }
  ...
  function getRoles(container, _temp) {
    ...
    return flattenDOM(container).filter(function (element) {
      ...
      return roles.reduce(function (rolesAcc, role) {
        ...
        return Array.isArray(rolesAcc[role]) ? _extends$1({}, rolesAcc, (_extends2 = {}, _extends2[role] = [].concat(rolesAcc[role], [node]), _extends2)) : _extends$1({}, rolesAcc, (_extends3 = {}, _extends3[role] = [node], _extends3));
      }, acc);
    }, {});
  }
  ...
  function waitFor(callback, _ref) {
    ...
    return new Promise( /*#__PURE__*/function () {
      var _ref2 = _asyncToGenerator$1( /*#__PURE__*/regenerator$1.mark(function _callee(resolve, reject) {
  ...
  function waitForWrapper(callback, options) {
    ...
    return getConfig().asyncWrapper(function () {
      return waitFor(callback, _extends$1({
  ...
  function _waitForElement() {
    _waitForElement = _asyncToGenerator$1( /*#__PURE__*/regenerator$1.mark(function _callee(callback, options) {
      return regenerator$1.wrap(function (_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
  ...
  */
  ...
  function _waitForElementToBeRemoved() {
    _waitForElementToBeRemoved = _asyncToGenerator$1( /*#__PURE__*/regenerator$1.mark(function _callee(callback, options) {
